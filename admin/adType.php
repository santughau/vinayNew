            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div align="right"> <a href="addAdType.php" class="btn btn-outline-primary">Add Types</a>
                            <hr> </div>
                            ...
                            <table class="table table-bordered display" id="table2excel">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="editAdType.php?id=<?php echo $data->adType_id;?>" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                                        <td><a href="adType.php?del=<?php echo $data->adType_id;?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php }?>
                                </tbody>
                            </table>
